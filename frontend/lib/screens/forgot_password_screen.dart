...
final res = await api.sendForgotPassword(email);
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Podés solicitar la recuperación fácilmente. Ingresá tu email y te contactaremos.",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 15,
                          color: isDark
