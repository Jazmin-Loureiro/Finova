...
class _MoneyMakerListScreenState extends State<MoneyMakerListScreen> {
        ...
        : moneyMakers.isEmpty
            ...
            : CustomRefreshWrapper(
                ...
                child: ListView(
                  ...
                  children: [
                    // TODO: TODO EL CONTENIDO ORIGINAL AQUÍ
                    // NO SE TOCA NADA
                    SizedBox(
                      height: 210,
                      child: PageView.builder(
                        ...
                        onPageChanged: (index) async {
                          ...
                          await context
                              ...
                              .loadRegisters(moneyMakers[index].id);
                          if (mounted) setState(() => isPageLoading = false);
                        },
                        itemBuilder: (context, index) {
                          // TU CARD COMPLETA QUEDA INTACTA
                    ...
                    if (isPageLoading)
                      ...
                      const EmptyStateWidget(
                        ...
                        message:
                            "Agrega un registro de dinero para comenzar a gestionar tus finanzas.",
                      )
                    else
  ...
  // ⭐⭐ BARRA ABAJO — MONEY MAKERS ES EL ÍNDICE 3
  bottomNavigationBar: const NavigationBarWidget(currentIndex: 3),
  );
  }
}